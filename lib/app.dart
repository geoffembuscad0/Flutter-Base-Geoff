...
import 'src/features/company-auth/company_auth_page.dart';
  ...
  Widget build(BuildContext context) {
    var kRouter = GoRouter(
      routes: [
        ...
        GoRoute(
          path: AppRoutes.companyAuth,
          builder: (context, state) {
            return const CompanyAuthPage();
          },
        ),
        GoRoute(
          path: '/home/:menu',
      ...
      initialLocation: authProvider.isLoggedIn ? AppRoutes.dashboard : AppRoutes.companyAuth,
      redirect: (state) {
